<?php
// Fixed by Rabyte Build @github 2024
...
<div class="page">
	<div class="content">
	<!-- Server problems fixed by @onepalazzo, 2024 year -->
		<section class="headline"><h1 class="title"><span class="title-text">Activation is done! Activation Info:</span></h1></section>
